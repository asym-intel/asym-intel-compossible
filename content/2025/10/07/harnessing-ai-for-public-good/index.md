---
title: "Harnessing AI For Public Policy"
date: 2025-10-07T15:40:07+00:00
...
![](/images/uploads/2025/10/android.webp)AI generated image, author.
...
## Leveraging AI for Public Good While Safeguarding Our Future

The twenty-first century is defined by complex, interconnected crises, from climate collapse to rampant inequality. 

For any progressive movement dedicated to systemic, structural reform and social justice, traditional policy methods (often based on linear or speculative assumptions) are no longer sufficient. A need highlighted by the failure of conventional models to anticipate or explain systemic shocks like the 2008 global financial crisis (GFC). As former European Central Bank President Jean-Claude Trichet noted during the global financial crisis, policymakers felt "_abandoned by conventional tools_ " as existing macro models "_failed to predict the crisis and seemed incapable of explaining what was happening_." This analytical gap has created a strategic imperative for more adaptive and granular methods.

> _Artificial Intelligence (AI) is not a utopian solution, but it is an essential tool for achieving genuine societal resilience._
...
This article outlines the applications of these computational paradigms—data-driven forecasting and agent-based simulation—their core challenges, and the profound governance imperatives that accompany their adoption. I am obviously aware of the many justifiable concerns about how AI can be used as an anti-democratic tool, but too often those concerns are couched in wholly negative terms which offer no positive role for AI.3
...
The dual emergence of Artificial Intelligence (**AI**) and Computational Social Science (**CSS**) offers a transformative response to the changes and challenges we face. Together, these tools enable a shift from static, equilibrium-based analysis to dynamic, data-rich modelling (which is necessary for the chaotic non-linear agent based world we live in) in a reinforcing positive synergistic loop:
  ...
  * data-driven forecasting helps predict _what_  might happen
  * while agent-based simulation helps explore _why_  it might happen and test the impact of "what if" policy interventions
...
## **AI as AN Engine of Public Good**

> AI offers transformative capabilities across critical sectors, allowing us to implement progressive policies with enhanced precision and resilience. 

AI provides the rigorous analytical capacity needed to model complex economic systems and stress-test transformative proposals before they are enacted.5

**Optimising Economic Justice and Policy**

  * **Designing Optimal Progressive Taxation:** We can utilise frameworks like the **" AI Economist,"**6 which employs Multi-Agent Reinforcement Learning (**MARL**), to model sophisticated economic systems. Simulations show that AI-designed tax policies consistently achieve a better balance of equality and productivity, leading to higher overall social welfare compared to existing models. This helps ensure that progressive tax reforms better achieve their intended outcomes and are not just popular populist slogans (which may in fact worsen the economy and the unequal distribution of wealth).
  * **Strategic Shock Modelling:** For major structural changes, such as nationalising utilities7 (like Thames Water, as the Green Party UK have promised to do8), advanced AI models based on game theory can simulate the actions of diverse stakeholders and market forces (in addition to the expected captured media resistance). **This strategic foresight helps policy designers select optimal legislative and communication pathways to maximise the chance of a successful, non-disruptive transition.**
...
## **Accelerating Climate Action and Ecological Resilience**
...
The green transition demands technological sophistication, which AI can deliver. AI offers transformative solutions essential for decarbonisation and ecological resilience.
  ...
  * **Smart Grid Optimisation:** AI is leveraged for optimising the flexible energy grid and enhancing demand-side management to accelerate renewable integration. Implementing advanced neural networks for forecasting wind and solar power output can increase the value of renewables and reduce the necessity for high-carbon backup sources.9
  * **Planetary Monitoring:** AI-powered systems can revolutionise biodiversity monitoring10 by processing vast datasets from Earth Observation (**EO**) and Autonomous Underwater Vehicles (**AUVs**). This enables rapid identification of invasive species, early detection of harmful algal blooms (**HABs**), and near-real-time tracking of changes in marine ecosystems.11
  * **Green Science Discovery:** AI can dramatically accelerate the discovery of new materials, such as Metal-Organic Frameworks (**MOFs**), which are critical for green technology applications like direct-air carbon capture.12
  * **Public Safety and Health:** AI can be used to model and analyse extreme weather events (like floods and droughts)13 to improve disaster preparedness and optimise resource allocation. In urban areas, AI tools like DeepMind’s "Green Light" can optimise traffic lights to reduce stop-and-go traffic, lowering vehicle emissions and improving urban air quality.14

![](/images/uploads/2025/10/sustainability-15-07643-g004.png)'AI-Enabled Energy Policy for a Sustainable Future':   
<https://www.mdpi.com/2071-1050/15/9/7643>

## Data-Driven Forecasting: Enhancing Predictive Capabilities with Artificial Intelligence
...
_**Current Applications and Methodologies**_
...
**Domain**| **AI/ML Application & Impact**  
---|---  
**Economic Forecasting**|  AI leverages machine learning algorithms and big data analytics to project key indicators like GDP growth, inflation, and unemployment. By analyzing vast amounts of data and handling non-linear relationships, models like ARIMA and SARIMAX (statistical methods that account for trends and seasonality in time-series data) overcome many limitations of traditional econometric methods, enhancing the granularity and timeliness of forecasts.  
**Energy Systems**|  In the renewable energy sector, AI is critical for forecasting solar and wind power generation. These predictions are essential for managing smart grids, optimizing the charging of energy storage systems, and ensuring the reliability of a power supply increasingly dependent on intermittent sources.  
**Climate and Weather Science**|  Machine learning models are integrated with conventional Numerical Weather Prediction (**NWP**) models to improve forecast accuracy. AI also enables real-time monitoring of environmental variables, such as air quality, deforestation rates, and greenhouse gas emissions, by processing vast streams of data from sensors and satellites.  
**Social Issues**|  Deep learning techniques are being applied to predict the occurrence of social issues like crime. These models analyse historical data across different regions and categories over time to forecast future incidents, providing a potential tool for resource allocation in law enforcement.  
  
_**Performance and Technological Edge**_

AI models have demonstrated a clear performance advantage over traditional methods, particularly in complex domains. In 24-hour ahead solar power forecasting, for example, a deep learning CNN-LSTM hybrid model was more than twice as good as traditional methods.15

The key technical advantages underpinning this performance include:

  * **Handling Unconventional Data:**  AI models can analyse vast and diverse datasets, including unconventional sources like social media or high-frequency market data, to provide more timely insights.
  * **Adaptability:**  These models can automatically update and recalibrate based on new information, reducing the need for manual intervention and enabling more responsive forecasting in dynamic environments.
  * **Non-Linearity:**  Unlike many traditional models that assume linear relationships, AI algorithms are expert at processing sequential data (time series)and excel at identifying and modelling complex, non-linear patterns.



_**Strategic Implications for Policymakers**_

The enhanced predictive power of AI forecasting offers a significant upgrade to the public sector's analytical toolkit. Policymakers should focus on building the institutional capacity to leverage these tools for more proactive and evidence-based governance. While data-driven forecasting offers powerful predictive capabilities, it can lead to the 'black box' issue. To understand underlying causal mechanisms and test policy interventions, we must also use a complementary, bottom-up approach known as simulation modelling.

## Simulation and Emergence: Agent-Based and Computational Social Science Models

Agent-Based Modelling (**ABM**) offers a fundamentally different "bottom-up" paradigm for analysis.16

Instead of modelling aggregate variables, ABM simulates macroeconomic and social dynamics from the ground up, based on the interactions of numerous heterogeneous "agents" (e.g., households, firms, individuals).17 Its strategic value lies in its ability to explore out-of-equilibrium dynamics, path dependencies, and emergent phenomena—complex system-wide behaviours that arise from simple micro-level interactions and are often beyond the scope of standard equilibrium models.
...
**_Core Principles and Methodologies_**

The ABM approach is defined by its focus on individual actors and their interactions within a simulated environment.

  * **Defining the Agent:**  An "agent" is a computational entity characterized by four key abilities: **autonomy**  (acting without direct control), **social ability**  (interacting with other agents), **reactivity**  (perceiving and responding to its environment), and **pro-activeness**  (taking initiative to pursue goals).
...
By simulating the behaviour of individual actors, ABM (and related computational models) provide a virtual laboratory for exploring complex policy questions across a wide range of fields.
  ...
  * **Macroeconomic Policy Analysis:**  Large-scale models like **Eurace@Unibi**19  are used to analyze the effects of economic policies by capturing the heterogeneity of firms and households. For example, these models can study the impact of labour market frictions on economic cohesion between different regions, revealing dynamics that are obscured in representative-agent models. They have also been used to model the effects of Basel II/III banking regulation on the financial fragility of the macroeconomic system.20
  * **Public Policy Experimentation:**  Simulation allows policymakers to explore policy trade-offs and potential unintended consequences in a controlled, virtual environment. This approach has been used to evaluate complex scenarios such as the effectiveness of different COVID-19 mitigation strategies21 and the potential impact on crime rates of shifting municipal funding between policing and social programs. However, studies on the impact of the use of AI during COVID-19 are also crucial to situate this in a wider social context.22
  * **Technology and Innovation Diffusion:**  ABMs are widely used to model how new technologies, behaviours, or ideas spread through a population.23 These models can simulate the adoption of rooftop solar panels or energy-saving practices, taking into account factors like social influence, network structure, and consumer preferences to inform policy interventions.
  * **Long-Term Historical Analysis:**  Projects like **[Seshat: Global History Databank](<https://www.researchgate.net/publication/314403909_Agent-Based_Modeling_of_Energy_Technology_Adoption_Empirical_Integration_of_Social_Behavioral_Economic_and_Environmental_Factors>)**24 demonstrate the power of computational methods for long-term social science. By converting vast amounts of historical and archaeological information into structured, machine-readable data, researchers can rigorously test competing theories about the evolution of complex societies and the drivers of inequality over millennia.
...
## Societal and Governance Imperatives: Navigating the Risks of AI-Driven Analysis

**_Amplification of Socio-Economic Inequality_**

There is documented evidence that the current trajectory of AI investment is linked to rising income disparities.28 This occurs through several mechanisms:

  * AI disproportionately benefits highly skilled workers while displacing lower-skilled jobs involving repetitive tasks. **This accelerates the need for universal basic income (UBI) to be implemented**29 ad well as the use of AI to monitor and take action on poverty, deprivation and inequality.30
...
**_Erosion of Democratic Norms and Concentration of Power_**
...
To navigate these risks, governance frameworks must be built on a foundation of core ethical principles.
  ...
  * **Transparency and Explainability:**  The "black box" problem must be mitigated to ensure that AI-driven decisions can be understood, scrutinised, and challenged by those they affect.
  ...
  * **Safety, Security, and Robustness:**  AI models must undergo rigorous validation and testing to ensure they are reliable, secure from manipulation, and perform as intended.
...
![](/images/uploads/2025/10/20250318-infographic-water-energy-consumption-c.jpg)
...
![](/images/uploads/2025/10/ai_environmental_sustainability.avif)"The Power of AI in Reaching Environmental Sustainability": <https://www.greenmatch.co.uk/green-intelligence-ai>

## **Foreign Ownership and Control (Sovereignty)**
...
This centralised control, often held by powerful foreign entities, threatens to make AI a tool of unjust corporate dominance and compromises national sovereignty.
  ...
  * **Foreign Control & Influence: **Furthermore, the outsourcing of critical functions like education, defence, or social safety nets to foreign AI companies raises serious questions about national sovereignty. This concentration also leads to heightened security risks and the potential for unfair influence on regulatory frameworks.34
  ...
  * We must invest in building a robust domestic public AI ecosystem to ensure that critical functions benefit the UK and our European partners and are free from direct and indirect foreign interference. **The EU has shown us the way with its multi-lingual LLM foundation model – Tilde.**35
...
## Implementing the Governance Roadmap
...
## **AI – A New Tool To Serve Humanity**
...
## Footnotes
  ...
  1. <https://www.independent.co.uk/news/silicon-valley-mark-zuckerberg-peter-thiel-god-nobel-prize-b2816511.html> ↩︎
  2. <https://jasonhickel.substack.com/p/why-capitalism-is-fundamentally-undemocratic> ↩︎
  3. <https://www.theguardian.com/commentisfree/2025/oct/09/artificial-intelligence-research-election-threats> ↩︎
  4. <https://pmc.ncbi.nlm.nih.gov/articles/PMC12289707/> ↩︎
  5. Bank of England: "_Infusing economically motivated structure into machine learning methods (2025) "how economic theory can be integrated into machine learning (ML) models to enhance their interpretability and applicability for policy analysis_" <https://www.bankofengland.co.uk/-/media/boe/files/working-paper/2025/infusing-economically-motivated-structure-into-machine-learning-methods.pdf> ↩︎
  6. <https://arxiv.org/abs/2108.02755> ↩︎
  7. <https://www.bbc.co.uk/news/articles/cy50vklw4vdo> ↩︎
  8. <https://greenparty.org.uk/2024/06/26/plan-for-our-rivers-greens-say-privatise-water-companies-invest-in-sewage-infrastructure-and-give-regulator-real-teeth/> ↩︎
  9. <https://www.sciencedirect.com/science/article/pii/S0306261925007469> ↩︎
  10. <https://pml.ac.uk/news/revolutionizing-biodiversity-monitoring-the-power-of-ai-and-new-technologies/> ↩︎
  11. <https://www.turing.ac.uk/research/research-projects/ai-and-autonomous-systems-assessing-biodiversity-and-ecosystem-health> ↩︎
  12. <https://www.chemistryworld.com/news/ai-enables-quicker-search-for-mofs-to-soak-up-carbon-dioxide/4022023.article> ↩︎
  13. <https://wmo.int/media/magazine-article/future-of-flood-forecasting-technology-driven-resilience#:~:text=The%20Ministry%20is%20now%20advancing,to%20generate%20dynamic%20flood%20simulations.> ↩︎
  14. <https://publicpolicy.google/resources/europe_ai_opportunity_climate_action_en.pdf> ↩︎
  15. It achieved a normalized root mean square error (NRMSE) of just 7.8%, a significant improvement over the 16.5% error rate of the persistence model baseline. ↩︎
  16. <https://hai.stanford.edu/policy/simulating-human-behavior-with-ai-agents> ↩︎
  17. <https://youtu.be/FOPu5xM5z2s?si=JIn3VypdoT9stJn3> ↩︎
  18. <https://www.researchgate.net/publication/228969790_The_ODD_protocol_A_review_and_first_update> ↩︎
  19. <https://shs.hal.science/halshs-00339756v1/document> ↩︎
  20. <https://www.uni-bielefeld.de/fakultaeten/wirtschaftswissenschaften/lehrbereiche/etace/eurace@unibi/> ↩︎
  21. <https://www.nature.com/articles/s41598-022-17892-8> ↩︎
  22. <https://www.nature.com/articles/s41599-025-04564-x> ↩︎
  23. <https://www.researchgate.net/publication/314403909_Agent-Based_Modeling_of_Energy_Technology_Adoption_Empirical_Integration_of_Social_Behavioral_Economic_and_Environmental_Factors> ↩︎
  24. <https://seshatdatabank.info/> ↩︎
  25. <https://en.wikipedia.org/wiki/Environmental_impact_of_artificial_intelligence> ↩︎
  26. <https://www.nuffieldfoundation.org/students-teachers/q-step> ↩︎
  27. <https://businesscloud.co.uk/news/the-alan-turing-institute-behind-the-unrest-at-the-ai-powerhouse/#:~:text=Staff%20submitted%20a%20whistleblowing%20complaint,defined%20by%20fear%20and%20defensiveness.> ↩︎
  28. <https://www.cgdev.org/blog/three-reasons-why-ai-may-widen-global-inequality> ↩︎
  29. <https://blogs.lse.ac.uk/businessreview/2025/04/29/universal-basic-income-as-a-new-social-contract-for-the-age-of-ai-1/> ↩︎
  30. <https://healthandscienceafrica.com/2025/08/artificial-intelligence-universal-weapon-against-poverty-in-africa-tech-expert/> ↩︎
  31. <https://muse.jhu.edu/pub/1/article/970356> ↩︎
  32. <https://www.iod.com/news/science-innovation-and-tech/major-blockers-to-ai-adoption-in-british-business/> ↩︎
  33. <https://goodlawproject.org/palantir-poised-to-cash-in-on-wes-streetings-nhs-plan/> ↩︎
  34. <https://www.intereconomics.eu/contents/year/2025/number/2/article/big-tech-and-the-us-digital-military-industrial-complex.html> ↩︎
  35. <https://digital-strategy.ec.europa.eu/en/library/eu-funded-tildeopen-llm-delivers-european-ai-breakthrough-multilingual-innovation> ↩︎
