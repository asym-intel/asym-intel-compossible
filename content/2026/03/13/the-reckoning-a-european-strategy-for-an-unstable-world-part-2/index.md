---
title: "The Reckoning: A European Strategy For an Unstable World (Part 2)"
date: 2026-03-13T09:42:16+00:00
...
> _" The art of war is of vital importance to the state. It is a matter of life and death, a road either to safety or to ruin."_3
> 
> (Sun Tzu)
...
China’s humiliation in the Opium Wars was the culmination of many failures, above all an insistence on an obsolete picture of the world and a refusal to register how industrial naval power had changed the conversion of economic strength into geopolitical force. The Qing court assumed that established rituals, tribute relationships and continental depth would continue to guarantee security. They did not. Defeat, unequal treaties and foreign spheres of influence followed; the “century of humiliation” saw the imperial state decay and the country fragment into warlord fiefdoms.

Not everyone in China was blind. Wei Yuan looked out at the new world and understood that the country faced an external system that had become faster, richer, and more violent than the one its institutions had been built to manage. His prescription was simple and ruthless: study the barbarians, copy what works, and build the ships and guns that would allow China to survive in the new order. It took China a century to act on that advice at scale.

Today, in 2026, Europe is repeating the same mistake in a different key. We are clinging to an obsolete picture of the world order and treating alliance habits as if they were laws of physics. On that narrow point, von der Leyen is right: Europe is failing to adapt to the structure of the threats it faces, and the price of that failure is rising from strategic inconvenience toward existential risk. Unlike 19th‑century China, we still have the time, wealth and institutional capacity to choose a different path—but only if we start doing our own Wei Yuan work now.
...
> _" China is now acting primarily from a position of vulnerability ._._.these vulnerabilities create scope for a more proactive, leverage-based EU diplomacy. "_6
> 
...
Garcia-Herrero and Rühlig document four compounding structural crises that will define China's trajectory for the next decade: 
  ...
  * **Rising international technological barriers:** as US export controls on semiconductors and quantum technologies close off the innovation pathways China's growth model depends on. Officially China grew at 5% in 2025. The EUISS projects this falling below 2.5% within ten years, with some analysts placing it as low as 1% as early as 2026.[](<https://www.iss.europa.eu/publications/analysis/dependence-gap-russia-china-relations>)​
...
The window for leverage-based diplomacy - the triangular strategy this article advises - is open and best taken advantage of now precisely because China is fragile. That window closes as China's self-reliance drive succeeds. Europe must take advantage of this window while it still can. As the report states: [](<https://www.iss.europa.eu/publications/analysis/dependence-gap-russia-china-relations>)​

> _" This leverage will not last indefinitely. Without a change in policy, China will continue to gradually reduce its reliance on European technology. The EU _… _needs to act now. "_

* * *

## **A Network of Criminal Enterprise** s
...
> _" Europe's policy of subservience has failed. The Trump administration clearly considers European subservience a sign of weakness."_ 7
...
The asymmetry with the Chinese position in respect of the EU is striking. China's official position — stated by Xi Jinping and Wang Yi explicitly and repeatedly at the highest level — is that it _supports_ European strategic autonomy.12 A coherent EU reduces US leverage and creates diplomatic space Beijing can use. China wants a _dependent_ Europe - specifically dependent on Chinese supply chains, technology, and infrastructure. However, it needs the EU institutional framework to function to make that dependency possible.
...
Newton showed that _force = mass * acceleration_. Europe has the economic weight of a superpower, but almost no mechanisms to translate that into political force in its own defence and for its own foreign policy interests. It is very slow to act, as witnessed with its failures to take action against Hungary.
...
_So how does the EU ensure it sits within a safe geopolitical Lagrange space?_
...
> "China derives considerable benefits from a weakened but stable Russia — one increasingly [dependent](<https://www.swp-berlin.org/10.18449/2024RP06/#hd-d44648e390>) on Beijing for economic markets, technological alternatives and diplomatic cover."18
...
The new European Russian strategy must involve:
  ...
  * **3\. Rebuild OSCE frameworks**19**:** It is the one multilateral institution that includes both Russia and all EU member states and was designed for exactly this purpose.
